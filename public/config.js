(function () {
  ...
  if (!resolved && (isFileProtocol || isCapacitorNative)) {
    resolved = mobileFallbackBase || 'http://10.0.2.2:3000';
  }

  // No app desktop, o frontend e API rodam no mesmo host/porta.
  // Mantemos vazio para que os fetches usem origem relativa.
